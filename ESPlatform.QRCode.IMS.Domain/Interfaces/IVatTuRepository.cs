...
public interface IVatTuRepository : IRepositoryBase<QlvtVatTu> {
    ...
    Task<PagedList<dynamic>> ListAsync( string tenVatTu, string maVatTu, int idKho, int idViTri, string maNhom, string relativeBasePath, int pageIndex, int pageSize);
