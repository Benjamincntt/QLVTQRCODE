...
```
 dotnet ef dbcontext scaffold "Data Source=192.168.68.249;User ID=dev.nmd_tm_24_qrcode_dev;Password=dev.nmd_tm_24_qrcode_dev@123;Initial Catalog=NMD_THACMO_24_QRCODE_DEV;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer -p "ESPlatform.QRCode.IMS.Test/ESPlatform.QRCode.IMS.Test.csproj" -o _Scaffold -n ESPlatform.QRCode.IMS.Test._Scaffold -c AppDbContext --context-dir _Scaffold --context-namespace ESPlatform.QRCode.IMS.Test._Scaffold -f --no-onconfiguring
